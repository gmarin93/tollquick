...
var Query = {
    diff: function (_, args) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, oldSchema, newSchema;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                            load_1.loadSchema(args.oldSchema),
                            load_1.loadSchema(args.newSchema),
                        ])];
                    case 1:
                        _a = _b.sent(), oldSchema = _a[0], newSchema = _a[1];
                        return [2 /*return*/, core_1.diff(oldSchema, newSchema)];
                }
            });
        });
    },
