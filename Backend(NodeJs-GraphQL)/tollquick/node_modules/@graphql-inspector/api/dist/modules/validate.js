...
var Query = {
    validate: function (_, args) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, schema, documents;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                            load_1.loadSchema(args.schema),
                            load_1.loadDocuments(args.documents),
                        ])];
                    case 1:
                        _a = _b.sent(), schema = _a[0], documents = _a[1];
                        return [2 /*return*/, core_1.validate(schema, documents)];
                }
            });
        });
    },
...
var InvalidDocument = {
    errors: function (doc) {
        if (doc.errors) {
            return doc.errors.map(function (error) { return ({
