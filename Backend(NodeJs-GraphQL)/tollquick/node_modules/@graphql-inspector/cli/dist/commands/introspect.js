...
function introspect(schemaPointer, options) {
    return __awaiter(this, void 0, void 0, function () {
        var output, renderer, schema, introspection, filepath, content, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    output = options.write || 'graphql.schema.json';
                ...
                case 2:
                    schema = _a.sent();
                    introspection = graphql_1.introspectionFromSchema(schema);
                    filepath = path_1.resolve(process.cwd(), output);
                    content = void 0;
