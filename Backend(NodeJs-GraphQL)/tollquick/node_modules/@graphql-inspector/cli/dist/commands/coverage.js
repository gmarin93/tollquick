...
function coverage(documentsPointer, schemaPointer, options) {
    return __awaiter(this, void 0, void 0, function () {
        var renderer, silent, writePath, shouldWrite, schema, documents, coverage_1, absPath, ext, output, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    documents = _a.sent();
                    coverage_1 = core_1.coverage(schema, documents);
                    if (!silent) {
                        renderer.coverage(coverage_1);
                    }
                    if (shouldWrite) {
