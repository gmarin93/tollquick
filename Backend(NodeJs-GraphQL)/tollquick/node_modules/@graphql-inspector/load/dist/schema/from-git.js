...
exports.fromGit = function fromGit(pointer) {
    if (isGit(pointer)) {
        return function load() {
            return __awaiter(this, void 0, void 0, function () {
                var _a, ref, path, git, schemaString, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, git.show([ref + ":" + path])];
                        case 2:
                            schemaString = _b.sent();
                            return [3 /*break*/, 4];
                        case 3:
                            error_1 = _b.sent();
                            throw new Error('Unable to load schema from git: ' + error_1);
                        case 4:
                            if (/\.(gql|graphql)$/i.test(path)) {
                                return [2 /*return*/, graphql_1.buildSchema(schemaString)];
                            }
...
//# sourceMappingURL=from-git.js.map