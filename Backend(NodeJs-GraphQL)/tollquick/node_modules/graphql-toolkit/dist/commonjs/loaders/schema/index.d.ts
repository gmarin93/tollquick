...
export declare const loadSchema: <T = any>(pointToSchema: string, options?: T, schemaHandlers?: (IntrospectionFromUrlLoader | IntrospectionFromFileLoader | SchemaFromString | SchemaFromExport | SchemaFromTypedefs)[]) => Promise<DocumentNode | GraphQLSchema>;
